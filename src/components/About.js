            ...
            <div className="about-inner">
              <Heading size={4} subtitle>
                <div className="has-text-light">
                  ...
                  programming, writing, music, and gaming. I am a graduate of
                  Zuitt's Coding Bootcamp where I learned the use of HTML, CSS,
                  JavaScript, PHP, Node among a myriad of other technologies to
                  create a website.
                </div>
              </Heading>
            </div>
